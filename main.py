...
# Main window
algo_visual = Tk()
algo_visual.title("Sorting Algorithms Visualization")
algo_visual.maxsize(1000, 700)
algo_visual.config(bg = WHITE)


algorithm_name = StringVar()
# algo_list is to select which algorithm we want to use to sort
algo_list = ['quick sort', 'Merge Sort','insertion sort']
...
### User interface here ###
UI_frame = Frame(algo_visual, width= 900, height=300, bg=WHITE)
...
canvas = Canvas(algo_visual, width=800, height=400, bg=WHITE)
canvas.grid(row=1, column=0, padx=10, pady=5)

algo_visual.mainloop()